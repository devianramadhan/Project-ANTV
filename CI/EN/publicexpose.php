...
<div id="wrapper">
    ...
    <div id="banner_web_in">
    	<img src="images/banner_DIVIDEN_mdia2.jpg" />
    </div>
...
<div id="isi">
    ...
    <div style="padding-bottom:25px;">
        ...
        <h1 class="judul">Public Expose</h1>
	</div>
    ...
    <table>
      ...
      <tr>
        <td>May 2017</td>
        <td>MDIA Public Expose May 2017</td>
        <td><a href="Investor Relations/Public Expose/PUBLIC-EXPOSE-MDIA -Final-OK-CETAK.pdf"><img src="images/pdficon.png" width="50px" height="50px" align="center"/></a>
		</td>
      </tr>
	  <tr height="200px";>
        <td></td>
