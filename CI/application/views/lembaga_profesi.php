...
<div id="isi">
	<div style="padding-bottom:25px;">
        ...
        <h1 class="judul">Lembaga Profesi Dan Penunjang Pasar Modal</h1>
	</div>
    
	
    <!-- Posting pertama -->
    <div id="posting">
    <h3>Kantor Akuntan Publik</h3>
    <div id="headline">
        <p>Handoko Tomo Samuel  Gunawan &amp; Rekan (Moores Rowland)</p>
        ...
        <!-- Posting 2 -->
    <div id="posting">
    <h3>Notaris Publik</h3>
    <div id="headline">
        <p>Humberg Lie, S.H., S.E.,  M.kn.</p>
    ...
    <div id="headline">
        ...
        <!-- Posting 4 -->
    <div id="posting">
    <h3>Biro Administrasi Efek</h3>
    <div id="headline">
        <p>PT Sinartama Gunita</p>
